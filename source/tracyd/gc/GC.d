/*******************************************************************************
    ...
    at v2.105.0, with modifications to allow tracking
    allocations / deallocations via Tracy.
...
private pragma(crt_constructor) void gc_tracking_conservative_ctor()
{
    _d_register_tracking_conservative_gc();
}

extern(C) void _d_register_tracking_conservative_gc()
{
    import core.gc.registry;
    registerGCFactory("tracking-conservative", &initialize);
}

private pragma(crt_constructor) void gc_tracking_precise_ctor()
{
    _d_register_tracking_precise_gc();
}

extern(C) void _d_register_tracking_precise_gc()
{
    import core.gc.registry;
